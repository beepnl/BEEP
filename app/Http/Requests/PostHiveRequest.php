...
class PostHiveRequest extends Request {
	...
	public function rules()
	{
		return [
			...
			'bb_width_cm'			=> 'nullable|float|min:0',
			'bb_depth_cm'			=> 'nullable|float|min:0',
			'bb_height_cm'			=> 'nullable|float|min:0',
			'fr_width_cm'			=> 'nullable|float|min:0',
			'fr_height_cm'			=> 'nullable|float|min:0',
