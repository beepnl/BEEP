...
return [
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by enabling the development option of your browser and logging in at app.beep.nl. Then get your api_token from the <b>/authenticate response</b> and use it as your Bearer [api_token].',
    ],
