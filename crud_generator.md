...
# Alerts
## AlertRule
php artisan crud:generate AlertRule --fields='name#string; description#string; measurement_id#integer#unsigned; calculation#select#options={"min": "Minimum", "max": "Maximum", "ave": "Average", "der": "Derivative", "cnt":"Count"}; calculation_minutes#integer#unsigned; comparator#select#options={"=": "=", "<": "<", ">": ">", "<=": "<=", ">=": ">="}; comparison#select#options={"val":"Value", "dif":"Difference", "abs":"Absolute value", "abs_dif":"Absolute differerence"}; threshold_value#float; exclude_months#string; exclude_hours#string; alert_via_email#boolean; webhook_url#string; active#boolean; user_id#integer#unsigned; default_rule#boolean' --relationships='measurement#belongsTo#Measurement::class; user#belongsTo#User::class;' --form-helper=html --validations='measurement_id#required; calculation#required; comparator#required; comparison#required; threshold_value#required;'

php artisan crud:api AlertRule --fields='name#string; description#string; measurement_id#integer#unsigned; calculation#select#options={"min": "Minimum", "max": "Maximum", "ave": "Average", "der": "Derivative", "cnt":"Count"}; calculation_minutes#integer#unsigned; comparator#select#options={"=": "=", "<": "<", ">": ">", "<=": "<=", ">=": ">="}; comparison#select#options={"val":"Value", "dif":"Difference", "abs":"Absolute value", "abs_dif":"Absolute differerence"}; threshold_value#float; exclude_months#string; exclude_hours#string; alert_via_email#boolean; webhook_url#string; active#boolean; user_id#integer#unsigned; default_rule#boolean' --relationships='measurement#belongsTo#Measurement::class; user#belongsTo#User::class;' --validations='measurement_id#required; calculation#required; comparator#required; comparison#required; threshold_value#required;' --controller-namespace=Api

##Alert
php artisan crud:generate Alert --fields='alert_rule_id#integer#unsigned; alert_function#string; alert_value#string; measurement_id#integer#unsigned; show#boolean; location_name#string; hive_name#string; device_name#string; location_id#integer#unsigned; hive_id#integer#unsigned; device_id#integer#unsigned; user_id#integer#unsigned' --relationships='alert_rule#belongsTo#AlertRule::class; measurement#belongsTo#Measurement::class; location#belongsTo#Location::class; hive#belongsTo#Hive::class; device#belongsTo#Device::class; user#belongsTo#User::class;' --form-helper=html --validations='alert_rule_id#required;measurement_id#required; alert_value#required; user_id#required'

php artisan crud:api Alert --fields='alert_rule_id#integer#unsigned; alert_function#string; alert_value#string; measurement_id#integer#unsigned; show#boolean; location_name#string; hive_name#string; device_name#string; location_id#integer#unsigned; hive_id#integer#unsigned; device_id#integer#unsigned; user_id#integer#unsigned' --relationships='alert_rule#belongsTo#AlertRule::class; measurement#belongsTo#Measurement::class; location#belongsTo#Location::class; hive#belongsTo#Hive::class; device#belongsTo#Device::class; user#belongsTo#User::class;' --validations='alert_rule_id#required;measurement_id#required; alert_value#required; user_id#required' --controller-namespace=Api