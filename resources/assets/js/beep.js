...
$(function () { 
	...
	.on("changed.jstree", function (e, data) 
	{
		...
		parent_id = window.location.href.indexOf('parent_id=') > -1 ? window.location.href.split('parent_id=')[1] : null;

		//console.log(id, parent_id, data.node, window.location.href);
	...
	.jstree(
	{
	    "core" 	  : { "check_callback":checkCallback, "themes": { "variant":"small", "stripes":true } },
	    "state"   : { "key" : "main-category-tree" },
	...
	{
		var tree = data.instance.get_json(null, {"no_icon":true,"no_id":true,"no_data":true,"no_li_attr":true,"no_a_attr":true,"flat":true});
		//console.log(tree);
		var cats = [];
	...
	// Checklist editor
	var checkDraggable = function(nodes, e)
	{
