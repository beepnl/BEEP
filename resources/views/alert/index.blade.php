        ...
        <table id="table-alert" class="table table-responsive table-striped">
            ...
            @foreach($alert as $item)
                <tr>
                    ...
                    <td>{{ $item->alert_rule->name }}</td><td>{{ $item->alert_function }}</td><td>{{ $item->alert_value }}</td><td>{{ $item->measurement->pq_name_unit }}</td><td>{{ $item->show }}</td><td>{{ $item->location_name }}</td><td>{{ $item->hive_name }}</td><td>{{ $item->device_name }}</td>
                    <td col-sm-1>
