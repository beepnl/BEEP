		...
		<!-- small box -->
			<div class="small-box bg-green">
				<div class="inner">
					...
					<p>Data storage req Total / OK (201) req/min<br>TTNv2: {{ $data['store-lora-sensors-ttn-v2'] }} | v3: {{ $data['store-lora-sensors-ttn-v3'] }} | v3pb: {{ $data['store-lora-sensors-ttn-v3-pb'] }} | KPN: {{ $data['store-lora-sensors-kpn'] }} | KPN-T: {{ $data['store-lora-sensors-kpn-things'] }} | helium: {{ $data['store-lora-sensors-helium'] }} | ?: {{ $data['store-lora-sensors-'] }} | API: {{ $data['store-sensors'] }}</p>
				</div>
				<div class="icon">
		...
		<!-- small box -->
			<div class="small-box bg-blue">
				<div class="inner">
					...
					<p>Influx read/write /hr: last:{{$data['influx-last']}} | names/nc:{{$data['influx-names']}}/{{$data['influx-names-nocache']}} | device:{{$data['influx-device']}} | alert:{{$data['influx-alert']}} | wea:{{$data['influx-weather']}} | data:{{$data['influx-data']}} | log:{{$data['influx-flashlog']}} | res:{{$data['influx-research']+$data['influx-research-api']}} | csv:{{$data['influx-csv']}}
					</p>
				</div>
				<div class="icon">
