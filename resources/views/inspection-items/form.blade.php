<div class="col-xs-12">
	<div class="form-group {{ $errors->has('value') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="value" type="text" id="value" value="{{ $inspectionitem->value ?? ''}}" >
	...
	<div class="form-group {{ $errors->has('inspection_id') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="inspection_id" type="number" id="inspection_id" value="{{ $inspectionitem->inspection_id ?? ''}}" >
	...
	<div class="form-group {{ $errors->has('category_id') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="category_id" type="number" id="category_id" value="{{ $inspectionitem->category_id ?? ''}}" >
