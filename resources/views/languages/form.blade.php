<div class="col-xs-12">
	<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="name" type="text" id="name" value="{{ $language->name or ''}}" required>
	...
	<div class="form-group {{ $errors->has('name_english') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="name_english" type="text" id="name_english" value="{{ $language->name_english or ''}}" required>
	...
	<div class="form-group {{ $errors->has('icon') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="icon" type="text" id="icon" value="{{ $language->icon or ''}}" >
	...
	<div class="form-group {{ $errors->has('abbreviation') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="abbreviation" type="text" id="abbreviation" value="{{ $language->abbreviation or ''}}" required>
	...
	<div class="form-group {{ $errors->has('twochar') ? 'has-error' : ''}}">
	    ...
	    <div>
	        <input class="form-control" name="twochar" type="text" id="twochar" value="{{ $language->twochar or ''}}" required>
