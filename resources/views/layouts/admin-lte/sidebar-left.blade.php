<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview {{ preg_match('(users|roles|permissions|image|alert-rule|alert|sample-code|hive-tags|inspection-svgs)', Request::url()) === 1 ? 'active' : '' }}">
          <a href="#">
            <span><i class="fa fa-list"></i></span>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Route::currentRouteNamed('inspection-svg.index') ? 'active' : '' }}"><a href="{{ route('inspection-svg.index') }}"><i class="fa fa-qrcode"></i><span>Inspection SVG</span></a></li>
          </ul>
        </li>
        @endrole
    </ul>
