...
@section('page-title') {{ __('crud.management', ['item'=>'physicalquantity']) }}
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <table id="table-physicalquantity" class="table table-responsive table-striped">
                    <thead>
                        <tr>
                            <th>#</th><th>Name</th><th>Unit</th><th>Abbreviation</th><th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($physicalquantity as $item)
                        <tr>
                            ...
                            <td>{{ $item->name }}</td><td>{{ $item->unit }}</td><td>{{ $item->abbreviation }}</td>
                            <td col-sm-1>
                ...
                <div class="pagination-wrapper"> {!! $physicalquantity->render() !!} </div>
