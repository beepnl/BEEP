        ...
        @slot('body')
            ...
            @if (isset($language) && isset($categories))
                ...
                <div class="col-xs-12">
                    ...
                    <ol>
                        <li>Download the <a href="https://assets.beep.nl/static/lang/{{ $language->twochar }}.js">{{ $language->name_english }} app translations Javascript file ({{ $language->twochar }}.js) here</a></li>
